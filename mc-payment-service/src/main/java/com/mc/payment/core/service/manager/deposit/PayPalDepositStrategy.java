...
import com.mc.payment.gateway.adapter.PayPalPaymentGatewayAdapter;
...
@Slf4j
@Component("DepositStrategy_3")
public class PayPalDepositStrategy extends DepositTemplate {

    private final PayPalPaymentGatewayAdapter payPalPaymentGatewayAdapter;

    public PayPalDepositStrategy(IWebhookEventService webhookEventService,
                                 AppConfig appConfig,
                                 ...
                                 PayPalPaymentGatewayAdapter payPalPaymentGatewayAdapter) {
        ...
        this.payPalPaymentGatewayAdapter = payPalPaymentGatewayAdapter;
    }
